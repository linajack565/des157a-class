(function () {
	...
	window.addEventListener('load', function () {
		...
		toggleButton.innerText = 'Hide Caption';
		toggleButton.classList.add('toggle-caption');
		document.querySelector('figure').appendChild(toggleButton);

		toggleButton.addEventListener('click', function () {
			// Toggle the visibility of the figcaption
			if (figCaption.style.display === 'none') {
				figCaption.style.display = 'block';  // Show the caption
				toggleButton.innerText = 'Hide Caption';
				
			} else {
				figCaption.style.display = 'none';  // Hide the caption
				toggleButton.innerText = 'Show Caption';
			}
		});
		...
		document.addEventListener('mousemove', function (e) {
			// Position the flashlight at the mouse position
